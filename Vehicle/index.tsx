    ...
    <div className="space-y-6">
      ...
      <div className="p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100 space-y-6">
        <div className="border-b border-gray-200 pb-4">
          <h2 className="text-lg sm:text-xl font-bold text-gray-900">Cálculo do Bônus</h2>
          <p className="text-sm sm:text-base text-gray-600 mt-2">
            {type === "motorcycle" ? (
              <>
                Você recebe <span className="font-bold text-green-600">R$ 40</span> ao atingir a meta diária de 5 atendimentos.
                Cada atendimento adicional soma <span className="font-bold text-green-600">R$ 15</span> ao seu bônus.
              </>
            ) : (
              <>
                Você recebe <span className="font-bold text-green-600">R$ 40</span> ao atingir a meta diária de 6 atendimentos.
                Cada atendimento adicional soma <span className="font-bold text-green-600">R$ 15</span> ao seu bônus.
              </>
            )}
          </p>
        ...
        <div className="border-b border-gray-200 pb-4">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900">Exemplo de Cálculo</h3>
          <div className="mt-2 bg-gray-50 p-4 rounded-lg text-sm sm:text-base">
            {type === "motorcycle" ? (
              <>
                <p>5 atendimentos (meta) → <span className="font-bold">R$ 40</span></p>
                <p>+ 4 atendimentos adicionais → <span className="font-bold">R$ 60</span> (4 × R$ 15)</p>
                <p className="font-bold text-green-600 border-t border-gray-200 pt-2 mt-2">Total para 9 atendimentos: R$ 100</p>
              </>
            ) : (
              <>
                <p>6 atendimentos (meta) → <span className="font-bold">R$ 40</span></p>
                <p>+ 4 atendimentos adicionais → <span className="font-bold">R$ 60</span> (4 × R$ 15)</p>
                <p className="font-bold text-green-600 border-t border-gray-200 pt-2 mt-2">Total para 10 atendimentos: R$ 100</p>
              </>
            )}
          </div>
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900">Casos Especiais</h3>
  ...
  return (
    <div className="flex flex-col w-full items-center py-6 px-4 sm:px-6 lg:px-8 min-h-screen">
      <div className="w-full max-w-2xl">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 text-center">Regras do Bônus</h1>
